...
// web 端新增可选字段 userIntake / lowIntakeWarn / exerciseAdvice（原版无），排除后再比 keys
const webPlanKeys = Object.keys(pWeb).filter(k => k !== 'userIntake' && k !== 'lowIntakeWarn' && k !== 'exerciseAdvice').sort()
